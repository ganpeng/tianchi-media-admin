        ...
        if (loader) {
            loaders.push({
                ...
                options: Object.assign({}, loaderOptions, {
                    ...
                    '$baseLightGray: #606060;$baseRed: #F56C6C;$asideIconColor: #B8C7CE;$deepRed: #D0021B;$lightBlue: #4BA5FF;'
                })
            });
        }
        ...
        scss: generateLoaders('sass').concat(
            {
                ...
                options: {
                    resources: path.resolve(__dirname, '../src/assets/css/setting/variable.scss')
                }
            }
        ),
