            ...
            <div class="wrapper">
                <div :style="styleBgImageStr(0)" class="field-1">
                    <corner-mark :squareIndex="0"
                                 :cornerMark="getLayoutItemCornerMark(navbarId, index, 0)">
                    </corner-mark>
                    <shuffle-btn
                        v-if="isEdit"
            ...
            <div class="wrapper">
                <div :style="styleBgImageStr(1)" class="field-2">
                    <corner-mark :squareIndex="1"
                                 :cornerMark="getLayoutItemCornerMark(navbarId, index, 1)">
                    </corner-mark>
                    <shuffle-btn
                        v-if="isEdit"
            ...
            <div class="wrapper">
                <div :style="styleBgImageStr(2)" class="field-3">
                    <corner-mark :squareIndex="2"
                                 :cornerMark="getLayoutItemCornerMark(navbarId, index, 2)">
                    </corner-mark>
                    <shuffle-btn
                        v-if="isEdit"
            ...
            <div class="wrapper">
                <div :style="styleBgImageStr(3)" class="field-4">
                    <corner-mark :squareIndex="3"
                                 :cornerMark="getLayoutItemCornerMark(navbarId, index, 3)">
                    </corner-mark>
                    <shuffle-btn
                        v-if="isEdit"
    ...
    export default {
        ...
        methods: {
            ...
            addLayout(type) {
                ...
                switch (type) {
                    case 'SHUFFLE':
                        this.$router.push({
                            name: 'ShuffleModule',
                            params: {navbarId, index: this.index, operator: 'add'},
                            query: {id}
                        });
                        break;
                    case 'FIGURE':
            ...
            editHandler() {
                ...
                this.$router.push({
                    name: 'ShuffleModule',
                    params: {navbarId, index: this.index, operator: 'edit'},
                    query: {id}
                });
            },
            deleteHandler() {
