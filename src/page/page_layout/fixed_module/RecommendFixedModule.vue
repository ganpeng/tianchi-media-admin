<template>
    <div class="recommend-fixed-module-container">
                ...
                <div class="right-field-wrapper">
                    ...
                    <div class="wrapper">
                        <div :style="styleBgImageStr(0)" class="right-bottom-field">
                            <corner-mark :squareIndex="0"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 0)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
                ...
                <div class="bottom-field">
                    <div class="wrapper">
                        <div :style="styleBgImageStr(3)" class="bottom-left-field">
                            <corner-mark :squareIndex="3"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 3)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
                    ...
                    <div class="wrapper">
                        <div :style="styleBgImageStr(4)" class="bottom-middle-field">
                            <corner-mark :squareIndex="4"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 4)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
                    ...
                    <div class="wrapper">
                        <div :style="styleBgImageStr(5)" class="bottom-right-field">
                            <corner-mark :squareIndex="5"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 5)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
                ...
                <div class="top-field">
                    <div class="wrapper">
                        <div :style="styleBgImageStr(1)" class="top-left-field">
                            <corner-mark :squareIndex="1"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 1)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
                    ...
                    <div class="wrapper">
                        <div :style="styleBgImageStr(2)" class="top-right-field">
                            <corner-mark :squareIndex="2"
                                         :cornerMark="getLayoutItemCornerMark(navbarId, 0, 2)"></corner-mark>
                            <shuffle-btn
                                v-if="isEdit"
        ...
        <programme-without4-step-dialog :squareIndex="squareIndex" :allowResolutions="allowResolutions"
                                        ref="selectProgrammeDialog"></programme-without4-step-dialog>
        <edit-programme-subject :squareIndex="squareIndex" :allowResolutions="allowResolutions"
                                ref="selectProgrammeSubjectDialog"></edit-programme-subject>
        <edit-channel :selectChannelSuccessHandler="selectChannelSuccessHandler"
                      ref="changeLiveChannelDialog"></edit-channel>
        <!-- 新增 -->
        <edit-programme-video :squareIndex="squareIndex" :allowResolutions="allowResolutions"
                              ref="selectProgrammeVideoDialog"></edit-programme-video>
        <link-dialog
            ...
            .content-field {
                ...
                .left-field-wrapper {
                    ...
                    .left-field {
                        ...
                        @include btnWrapper();
                        background: url("../../../assets/img/live_bg.png");
                        .live {
                            position: absolute;
                            bottom: 30px;
                            right: 30px;
