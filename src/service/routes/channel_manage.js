 ...
 * 获取频道的列表
 */
export const getChannelList = ({pageNum, pageSize, record, keyword, typeIdList, visible, category, common, companyCode, protocolList, refCount, paymentType, applicableClientList}) => {
    let params = {
        pageNum,
        pageSize,
        record,
