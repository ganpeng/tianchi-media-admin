...
import * as serverGroupRoutes from './routes/server_group';
import * as downloadManageRoutes from './routes/download_manage';
import * as bossRoutes from './routes/boss';
